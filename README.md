...
- 3.8.4 [`on the pot`] <- [Tag](https://github.com/AbuCTF/CTFRiced/releases/tag/3.8.4)
  - rebased to latest version
  - fix ui inconsistencies
  - patch security vulns
    - image allowlist bypass - participant could send `?name=ubuntu:latest` and the server would pull and run any public docker image.
    - DoS in docker host via improper container limit validation
    - env_vars in public challenge api - served as json on `read()`
    - SSRF in discord webhook via `user@evil.com#discord.com`
...
#### Post Credits
[2024](https://www.abu.rocks/docs/dev/h7ctf24-infrastructure/)

[2025](https://www.abu.rocks/docs/dev/h7ctf25-infrastructure/)
